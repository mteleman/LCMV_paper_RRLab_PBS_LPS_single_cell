...
```{r}
netVisual_bubble(cellchat, sources.use = c(8,9),targets.use = c(12), remove.isolate = TRUE,font.size =10)
netVisual_bubble(cellchat, sources.use = c(12),targets.use = c(8,9), remove.isolate = TRUE,font.size =10)
```
